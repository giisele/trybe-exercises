...
SELECT Piece, Price FROM PiecesProviders.Provides ORDER BY Provider LIMIT 4 OFFSET 3;
...
SELECT * FROM PiecesProviders.rovides ORDER BY Provider, Price DESC LIMIT 3;
