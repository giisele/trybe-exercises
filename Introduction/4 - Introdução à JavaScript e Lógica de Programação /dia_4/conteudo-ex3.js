let a = 5, b = 10, c = 7, valor = 9, ang1, ang2, ang3, chess, nota, valorCusto, valorVenda, salarioBruto;
...
function maior(a, b) {
  if (a > b && a > c) return console.log(a, 'é o maior numero');
  else if (b > a && b > c) return console.log(b, 'é o maior numero');
  else return console.log(c, 'é o maior numero');
}

//Faça um programa que retorne o maior de três números. Defina no começo do programa três variáveis com os valores que serão comparados.
function maiores(a, b, c) {
  if (a > b && a > c) return console.log(a, 'é o maior numero');
  else if (b > a && b > c) return console.log(b, 'é o maior numero');
  else return console.log(c, 'é o maior numero');
}
